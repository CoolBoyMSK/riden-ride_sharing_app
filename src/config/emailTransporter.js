...
const validateEmailConfig = () => {
  ...
  if (!env.SES_SMTP_USER || !env.SES_SMTP_PASS || !env.EMAIL_FROM) {
    throw new Error(
      '❌ Missing required email configuration: SES_SMTP_USER, SES_SMTP_PASS, and EMAIL_FROM must be set in environment variables'
    );
  }
