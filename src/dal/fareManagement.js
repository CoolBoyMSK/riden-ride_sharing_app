...
// services/fareManagementService.js
...
export const updateFareByZoneNameAndCarType = async (
  ...
  try {
    ...
    console.error('Error updating fare by zone name and car type:', error);
    return {
      success: false,
      error: error.message,
    };
...
export const getFareConfigurations = async (filters = {}, pagination = {}) => {
  try {
    ...
    console.error(
      'Error getting dynamic fare configurations with pagination:',
      error,
    );
    return {
      success: false,
...
export const deleteFareConfiguration = async (zoneId) => {
  try {
    ...
    console.error('Error deleting fare configuration:', error);
    return {
      success: false,
      error: error.message,
    };
...
export const getFareForLocation = async (lng, lat, carType) => {
  try {
    ...
    console.error('Error getting fare for location:', error);
    return null;
  }
};
