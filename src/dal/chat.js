...
export const createMessage = async ({ rideId, senderId, text, messageType = 'text', attachments = [] }) => {
  try {
...
export const markAllMessagesRead = async (rideId, userId) => {
  try {
    ...
    return { modifiedCount: unreadMessages.length };
  } catch (error) {
